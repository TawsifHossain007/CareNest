      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
        <div className="max-w-md">
          ...
          <p className="text-gray-500 mb-6">
            You have not made any bookings yet. Explore our services and book
  ...
  return (
    <div className="p-6">
      <div className="mb-6 flex items-center justify-between">
        ...
        <div>
          <Link href={"/services"} className="btn btn-primary text-white">
            Book Services <CiBookmarkCheck size={25} className="font-black" />
          </Link>
        </div>
      </div>
              ...
              {bookings.map((booking, index) => (
                ...
                >
                  ...
                  <td className="space-x-2 flex items-center">
                    <Link
                      href={`/dashboard/my-bookings/${booking._id}`}
